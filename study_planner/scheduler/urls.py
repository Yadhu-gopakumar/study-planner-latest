...
urlpatterns = [
    ...
    path("schedule/generate/",generate_schedule_form,name="generate_schedule_form"),
    path("schedule/generate/create/",generate_schedule_create,name="generate_schedule_create"),
